...
// const getAllCourses = async (req: Request): Promise<ResponseBase> => {
//     try {
//         const { pageIndex, keyword, categories } = req.query;
//         const skip = (Number(pageIndex) - 1) * 10;
//         const take = 10;
//         const stringCategories = categories as string[];
//         const numberArray = stringCategories.map(Number);

//         const courseCategories = await configs.db.courseCategory.groupBy({
//             by: ["course_id"],
//             where: {
//                 category_id: {
//                     in: numberArray,
...
//                 course_id: {
//                     _count: {
//                         gte: numberArray.length,
//                     },
//                 },
//             },
//         });
//         const courseId = courseCategories.map((item) => item.course_id);

//         const course = await configs.db.course.findMany({
//             where: {
//                 id: {
//                     in: courseId,
//                 },
...
//         });
//         return new ResponseSuccess(200, i18n.t("successMessages.getDataSuccess"), true, course);
//     } catch (error) {
//         return new ResponseError(500, i18n.t("errorMessages.internalServer"), false);
//     }
// };
// pageIndex={pageIndex}&keyword={keyword}&categories={categories1}&categories={categories2}&sortBy={sortBy}&rating={rating}
const CourseService = {
    getAllCourses,
    getRightOfCourse,
    getCourseDetail,
