...
import { Category as CategoryType, CourseDetail as CourseDetailType,ChangeInformation as ChangeInformationType } from "../types/course";
    ...
    {isLoading !== true && <>
        ...
        <div className="min-h-screen h-full container px-4 m-auto flex flex-col mt-11 laptop:flex-row laptop:gap-[76px]">
            <div className="flex-1 p-4">
                <div className="flex">
                    <div className="flex ">
                        <img ref={imageRef} src={`${courseDetail.thumbnail}`} alt="" className="w-[120px] h-[120px] rounded-lg mr-3 bg-[#D9D9D9]" />
                                            ...
                                            {displayCategories && (
                                                <div className="shadow top-100 bg-white z-[99] w-full lef-0 rounded max-h-select overflow-y-auto svelte-5uyqqj">
                                                    <div className="flex flex-col w-full overflow-y-scroll">
                                                        {categoriesSelector.map((category: any, index: number) => {
                                                            return (
                                                                <div
